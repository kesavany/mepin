...
public class MepinAuthenticator extends AbstractApplicationAuthenticator
    ...
    protected void initiateAuthenticationRequest(HttpServletRequest request,
        ...
        String loginPage = ConfigurationFacade.getInstance().getAuthenticationEndpointURL().replace("authenticationendpoint/login.do",
                                                                                                    "mepinauthenticationendpoint/mepinauth.jsp");
        String isSecondStep = "false";
        try {
    ...
    protected void processAuthenticationResponse(HttpServletRequest request,
        ...
        if ((!StringUtils.isEmpty(request.getParameter(MepinConstants.IS_SECOND_STEP))
            ...
            if (request.getParameter(MepinConstants.IS_SECOND_STEP).equals("true")) {
            ...
            try {
                ...
                transactionResponse = new MepinTransactions().createTransaction(mePinId, context.getContextIdentifier(),
                ...
                String transactionId = transactionResponse.getAsJsonPrimitive(MepinConstants.MEPIN_TRANSACTION_ID).getAsString();
